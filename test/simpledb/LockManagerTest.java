...
public class LockManagerTest {
    ...
    @Test public void lockOnePage() throws Exception {
        this.lockManager.lock(tid1, pid1, LockManager.LockMode.SHARED, LockManager.LockClass.LONG);
        ...
        this.lockManager.unlock(tid1, pid1);
        Assert.assertTrue(this.lockManager.isLocked(tid1, pid1));        
        this.lockManager.unlockTransaction(tid1);
    ...
    @Test public void lockWithThreeThreads() throws Exception {
        ...
        Thread t1 = new Thread() {
                public void run() {
                    try {
                        toT1.take();
                        lockManager.lock(tid1, pid1, LockManager.LockMode.SHARED, LockManager.LockClass.SHORT);
                        fromT1.put(0);

                        toT1.take();
                        lockManager.lock(tid1, pid1, LockManager.LockMode.EXCLUSIVE, LockManager.LockClass.SHORT);
                        fromT1.put(0);

                        toT1.take();
                        lockManager.unlockTransaction(tid1);
                        fromT1.put(0);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
        ...
        Thread t2 = new Thread() {
                public void run() {
                    try {
                        toT2.take();
                        lockManager.lock(tid2, pid1, LockManager.LockMode.SHARED, LockManager.LockClass.SHORT);
                        fromT2.put(0);

                        toT2.take();
                        lockManager.unlock(tid2, pid1);
                        fromT2.put(0);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
        ...
        Thread t3 = new Thread() {
                public void run() {
                    try {
                        toT3.take();
                        lockManager.lock(tid3, pid2, LockManager.LockMode.EXCLUSIVE, LockManager.LockClass.SHORT);
                        fromT3.put(0);
                        
                        toT3.take();
                        lockManager.lock(tid3, pid1, LockManager.LockMode.EXCLUSIVE, LockManager.LockClass.SHORT);
                        fromT3.put(0);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
